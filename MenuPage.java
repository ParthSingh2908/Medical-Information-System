...
class MenuPage {
    ...
    class Patient extends Person {
        ...
        public Patient(String id, String Pname, String Address, String Pnumber, String Age, String Sex, String illness) {
            this.id = id;
            this.Pname = Pname;
    ...
    class Doctor extends Person {
        ...
        public Doctor(String docId, String docName, String specialisation, String cabinNo, String phoneNumber, String perDayFee) {
            this.docId = docId;
        ...
        public void save(Connection conn) {
            try {
                ...
                stmt.setString(4, cabinNo);
                stmt.setString(5, phoneNumber);
                stmt.setString(6, perDayFee);
                stmt.executeUpdate();
    ...
    MenuPage()
    {
        ...
        menupageframe.setBackground(new Color(201, 218, 234));
        ...
        mainbodypanel.setBackground(new Color(201,218,234));
        ...
        panel1.setBackground(new Color(201, 218, 234));
        ...
        outbutton.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent ae)
            {
				...
				count= count+1;				  
				String billquery = "CREATE TABLE patient_"+count+" " +"(id int(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY, " +" bill_item VARCHAR(255), " + " billamount VARCHAR(255))";
				billpstmt = conn.prepareStatement(billquery);
				billpstmt.executeUpdate();
				System.out.println("Inserted into patient_id" );
				
                String id=Integer.toString(count);
                String Pname=outname.getText();
                String Address=outaddress.getText();
                String Pnumber=outnumber.getText();
                String Age=outage.getText();
                String Sex=outsex.getText();
                String illness=outillness.getText();

                Patient patient = new Patient(id, Pname,  Address,  Pnumber,  Age,  Sex, illness);
                patient.save(conn);
        ...
        panel2.setBackground(new Color(201, 218, 234));
        ...
        panel3.setBackground(new Color(201, 218, 234));
        ...
        try{            
            ...
            while(rs.next()){   
                ...
                doctormodel.addRow(new Object[]{name, specialisation, address, age});
...
//        panel4.setBackground(Color.yellow);
        ...
        panel4.setBackground(new Color(201, 218, 234));
	...
	// ID PANEL start	
        ...
        billidfield.setBounds(5,20,200,30);
        billidbutton.setBounds(300,20,200,30);
