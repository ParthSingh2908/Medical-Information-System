...
public class AboutUs{
	...
	AboutUs()
	{
       ...
       headerpanelsh.setBackground(new Color(201, 218, 234));            
        ...
        String text3 = "Symbiosis has been synonymous with quality education for over 50 years. Drawing strength from this trust, ‘Symbiosis University Hospital and Research Centre’ (SUHRC) was conceived to redefine healthcare in Pune by establishing a new state-of-the-art tertiary care hospital. Our purpose is to provide modern & professional healthcare to the Rural & Urban community equitably.";
