...
class HomePage {
    ...
    HomePage()
    {
        ...
        wrapper.setBackground(new Color(201, 218, 234));
...
//        logo.setBounds(50,0,100,100);
        ...
        // heading.setBounds(screenSize.width-700,30,700,55);
        ...
        // heading1.setBounds(screenSize.width-697,33,700,55);
        ...
        JLabel mainpanel_pic = new JLabel(new ImageIcon("Images//download.jpeg"));
        mainpanel_pic.setBounds(20,130,850,400);
        ImageIcon iconfounder1 = new ImageIcon("Images//download.jpeg");
        Image imgfounder1 = iconfounder1.getImage();
        Image newimg1 = imgfounder1.getScaledInstance(850, 400, Image.SCALE_SMOOTH ) ;  
